...
colors = {
    % No Glove (blue family - subtle variations)
    [0.0, 0.3, 0.7], [0.1, 0.4, 0.8], [0.2, 0.5, 0.9],
    % Passive Glove (green family - subtle variations)
    [0.0, 0.6, 0.3], [0.1, 0.7, 0.4], [0.2, 0.8, 0.5],
    % Active Glove (pink/magenta family - subtle variations)
    [0.9, 0.2, 0.5], [1.0, 0.3, 0.6], [1.0, 0.5, 0.7]
};
