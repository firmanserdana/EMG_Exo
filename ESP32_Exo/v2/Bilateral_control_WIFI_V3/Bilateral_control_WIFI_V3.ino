...
// ==================== Global Variables ====================
// Control modes
enum ControlMode { WEB_MODE, TCP_MODE };
...
void gestureToFingerStates() {
    ...
    if (gesture != lastGesture && (millis() - lastDirectControl > 100)) {
        ...
        switch (gesture) {
            case 0: finger_states = "000000"; break; // Relax
            case 1: finger_states = "111110"; break; // All flex
            case 2: finger_states = "222220"; break; // All extend
            case 3: finger_states = "330000"; break; // 2-finger pinch
            case 4: finger_states = "333000"; break; // 3-finger pinch
            case 5: finger_states = "100000"; break; // Thumb
            case 6: finger_states = "010000"; break; // Index
            case 7: finger_states = "001000"; break; // Middle
            case 8: finger_states = "011000"; break; // Peace gesture
            default: finger_states = "000000"; break;
        }
        status_changed = true;
    }
}
...
void setFingerStates() {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        switch (state) {
            case '1': digitalWrite(flexion_pins[i], HIGH); break;   // Flexion
            case '2': digitalWrite(extension_pins[i], HIGH); break; // Extension
            case '3': digitalWrite(pinching_pins[i], HIGH); break;  // Pinching
            default: break; // Relax state, all pins are LOW
        }
    }
...
void setSpeedDAC() {
    ...
    switch (speed) {
        case 0: valueC = 0; valueD = 0; break;
        case 1: valueC = 2048; valueD = 0; break;
        case 2: valueC = 2048; valueD = 2048; break;
        case 3: valueC = 4095; valueD = 2048; break;
        case 4: valueC = 4095; valueD = 4095; break;
    }
